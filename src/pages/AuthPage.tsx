...
import {
  ...
  AlertCircle, Loader2,
  ArrowLeft, Sparkles, Heart, Star, Droplets, TrendingUp, Award
} from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        // Small delay to ensure user context is updated
        setTimeout(() => {
          // All new users are customers, redirect to dashboard
          navigate('/dashboard');
        }, 100);
      } else if (mode === 'forgot') {
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm font-serif">
              ...
              {mode === 'signup' && 'Create your account to start shopping'}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-4 py-3.5 border text-sm ${errors.email ? 'border-red-300' : 'border-gray-300'
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-12 pr-4 py-3.5 border text-sm ${errors.fullName ? 'border-red-300' : 'border-gray-300'
                      } rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-12 pr-12 py-3.5 border text-sm ${errors.password ? 'border-red-300' : 'border-gray-300'
                      } rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors`}
                    placeholder="••••••••"
                    disabled={loading}
                    required
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-12 pr-12 py-3.5 border text-sm ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'
                      } rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors`}
                    placeholder="••••••••"
                    disabled={loading}
                    required
