...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden border border-neutral-200 relative"
        style={{
          position: 'relative',
          maxHeight: '90vh',
          overflow: 'hidden',
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`input-field-luxury pl-10 ${errors.email ? 'border-state-error focus:border-state-error focus:ring-state-error/20' : ''
                        }`}
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      className={`h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded ${errors.agreeToTerms ? 'border-state-error' : ''
                        }`}
                      disabled={loading}
                      required
                    />
