...
import { Users, UserPlus, Search, RefreshCw, Download, Edit, Trash2, Check, X, UserCheck, UserCog } from 'lucide-react';
import { getAllUsers, deleteUsersBulk, updateUsersBulk } from '../../../lib/supabase';
...
export const EnhancedUserManagement: React.FC = () => {
  ...
  const exportUsers = () => {
    // Create CSV content
    const headers = ['Name', 'Email', 'Role', 'Phone', 'Date of Birth', 'Active', 'Created At'];
    const csvContent = [
      headers.join(','),
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-indigo-500"
              />
            </div>
          </div>
          <div>
